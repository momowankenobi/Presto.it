<div class="container-fluid mt-5">
    <div class="row">
        <div style="background-color: #3B6097" class="col-12 col-md-6 text-light p-3 d-flex flex-column justify-content-around align-items-center">
        ...
        <div style="background-color: #4E79BA" class="col-12 col-md-6 d-flex text-light flex-column align-items-center justify-content-around p-3">
            ...
            <div class="d-flex w-100 align-items-center justify-content-around">
                ...
                <i class="fab fa-3x fa-paypal"></i>
                <i class="fab fa-3x fa-apple-pay"></i>
                <i class="fab fa-3x fa-google-pay"></i>
