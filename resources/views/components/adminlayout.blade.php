                ...
                <ul class="nav flex-column">
                  ...
                  <li class="nav-item">
                    <a class="nav-link text-light" href="{{route('admin.showrev')}}">
                      ...
                      Revisori <span class="badge rounded-circle bg-danger"> {{App\Models\User::ToBeRevisionedCount()}}</span>
                    </a>
                  </li>
                  @endif
                  ...
                  <li class="nav-item">
                    <a class="nav-link text-light" href="{{route('admin.rejectadd')}}">
                      ...
                      Cestino Annunci <span class="badge rounded-circle text-darker bg-warning"> {{App\Models\Add::RejectedCount()}}</span>
                    </a>
                  </li>
